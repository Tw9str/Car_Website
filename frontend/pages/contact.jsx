...
export default function Contact() {
  return (
    <div>Welkom bij BCP&lsquo; het auto bedrijf waar u terecht kunt voor al uw autozaken.
      ...
      Ontdek ons ruime aanbod aan tweedehands auto&apos;s en onze professionele diensten op onze website en neem contact met ons op voor meer informatie.</div>
  )
}
